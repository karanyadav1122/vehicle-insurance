...
class SimpleStorageService:
    ...
    def upload_file(self, from_filename:str, to_filename: str, bucket_name: str, remove:bool= True):
      ...
      try:
          ...
          if remove:
                    ...
                    logging.info(f"Removed local file from {from_filename} in {bucket_name}")
          logging.info("Exited the upload_file_method of simpleStorageService class")
    ...
    def get_df_from_object(self, object_:object) -> DataFrame:
      ...
      try:
          ...
          logging.info("Exited the get_df from object method of SimpleStoraeServiceClass")
          return df
    ...
    def read_csv(self, filename:str, bucket_name: str) -> DataFrame:
      ...
      try:  
          ...
          logging.info("Exited the read csv method of simple storagesevice class")
          return df
      except Exception as e:
        raise MyException(e, sys) from e
